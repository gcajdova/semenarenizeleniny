...
CREATE TABLE IF NOT EXISTS seeds (
    ...
    sowing_greenhouse_from TINYINT UNSIGNED NULL,
    sowing_greenhouse_to TINYINT UNSIGNED NULL,
    sowing_soil_from TINYINT UNSIGNED NULL,
    sowing_soil_to TINYINT UNSIGNED NULL,
    sowing_depth VARCHAR(80) NULL,
    transplant_from TINYINT UNSIGNED NULL,
    transplant_to TINYINT UNSIGNED NULL,
    ...
    KEY seeds_subcategory_idx (subcategory),
